            ...
            <div class="box-header">
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
					...
					<td><center>{{ is_array($client->phone) ? implode($client->phone, '-') : $client->phone }}</center>
                  </td>
					<td><center>{{$client->address}}</center>
						...
						@if(auth()->user()->hasPermission('create_clients'))
					<td><center>
						<a href="{{route('dashboard.clients.orders.create',$client->id)}}" class="btn btn-info">@lang('site.orders')</a></center></td>
					@else
					<td><center>
						<a href="#" class="btn btn-info disabled" >@lang('site.orders')</a></center></td>
		@endif
                  <td>
