...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a class="active" href="{{route('dashboard.categories.index')}}">@lang('site.categories')</a></li>
        ...
        <div class="col-xs-10">
          <div class="box">
            <div class="box-header">
				<h3 class="box-title">@lang('site.category')  <small>   </small></h3>
				<form action="{{route('dashboard.categories.index')}}" method="get">
					<div class="row">
					<input type="search" class="col-md-4 form-control" placeholder="@lang('site.search')" name="search" value="{{request()->search}}" >
						...
						@else
						<a href="{{route('dashboard.categories.create')}}" class="btn btn-warning disabled">
							<i class="fa 
						  fa-plus">
								@lang('site.add')</i>
						</a>
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <th>Id</th>
					...
					<th><center>@lang('site.products_count')</center></th>
					
					<th><center>@lang('site.related_products')</center></th>
                ...
                <tr>
					...
					<td><center>{{$cat->products->count()}}</center>
                  </td>
					<td><center><a href="{{route('dashboard.products.index',['category_id'=>$cat->id])}}" class="btn btn-info">@lang('site.related_products')</a></center></td>
		
                  <td>
					 @if(auth()->user()->hasPermission('update_categories'))
					  <a class="active btn btn-info" href="{{route('dashboard.categories.edit',$cat->id)}}"><i class="fa 
